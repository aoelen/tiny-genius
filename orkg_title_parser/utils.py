...
method_3_rx = '(strateg|methodolog|strateg|probabilit|theor|analog)(ies|y)'
...
system(s)?|tester|case|tool|generation|structure|foundation|framework|algorithm|process|resource(s)?|bases|strateg(ies|y)|problem|challenge|center|experiment|representation(s)?|theory|\
